...
/* package haskellFinal-0.1.0.0 */
#ifndef VERSION_haskellFinal
#define VERSION_haskellFinal "0.1.0.0"
#endif /* VERSION_haskellFinal */
#ifndef MIN_VERSION_haskellFinal
#define MIN_VERSION_haskellFinal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellFinal */
...
#define CURRENT_COMPONENT_ID "haskellFinal-0.1.0.0-inplace-haskellFinal"
